package СomputerScienceProblemsJava.chapter3;

import СomputerScienceProblemsJava.chapter3.constraint.Constraint;
    ...
    public CSP(List<V> variables, Map<V, List<D>> domains) {
        ...
        for (V variable : variables) {
            ...
            if (!domains.containsKey(variable)) {
                throw new IllegalArgumentException("Every variable should have a domain assignment to it.");
            }
        }
    }
