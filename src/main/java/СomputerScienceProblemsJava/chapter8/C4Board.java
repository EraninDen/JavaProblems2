...
public class C4Board implements Board<Integer> {
    ...
    public static final ArrayList<C4Location[]> SEGMENTS = generateSegments();//закастомил !!!
    ...
    private static ArrayList<C4Location[]> generateSegments() {
        ...
        return segments;//закастомил так как идея ругалась!
    }
    ...
    public Board<Integer> move(Integer location) {
        ...
        return new C4Board(tempPosition, (C4Piece) turn.opposite());//закастомил так как идея ругалась!
    }
    ...
    public int countSegment(C4Location[] segment, C4Piece color) {
        int count = 0;
