...
public class ListCompression extends Chromosome<ListCompression> {
    ...
    private static final List<String> ORIGINAL_LIST = List.of(
            "Michael", "Sarah", "Narine", "David", "Sajid", "Melanie", "Daniel", "Wei", "Dean", "Brian",
            "Murat", "Lisa");
    ...
    public static void main(String[] args) {
        ...
        ListCompression result = ga.run(GENERATION, THRESHOLD);
